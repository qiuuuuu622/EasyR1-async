...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto) -> dict[str, Any]:
        ...
        non_tensor_select_keys = ["multi_modal_inputs"]
        if self.config.loss_type == "areal" and "prox_log_probs" in data.batch:
            select_keys.append("prox_log_probs")
        ...
        for _ in range(self.config.ppo_epochs):
            ...
            for mini_batch in mini_batches:
                ...
                for micro_batch in micro_batches:
                    ...
                    # TODO fix prox_log_probs
                    old_log_probs = model_inputs.get("prox_log_probs", None)
                    advantages = model_inputs["advantages"]
                    prox_log_probs = model_inputs.get("prox_log_probs", None)
